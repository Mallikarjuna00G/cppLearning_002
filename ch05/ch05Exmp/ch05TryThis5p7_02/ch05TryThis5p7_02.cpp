// ch05TryThis5p7_02.cpp : This file contains the 'main' function. Program execution begins and ends there.
// Logic errors
...
{
    double sum = 0;
    constexpr double temp_high_limit = 2200;  // in F
    constexpr double temp_low_limit = -1000;  // in F
    double low_temp = temp_high_limit;  // initialize to "impossibly low"
    double high_temp = temp_low_limit;  // initialize to "impossibly high"
    int no_of_temps = 0;
