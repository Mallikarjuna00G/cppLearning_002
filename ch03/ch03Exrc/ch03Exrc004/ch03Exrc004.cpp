// ch03Exrc004.cpp : This file contains the 'main' function. Program execution begins and ends there.
// multiple basic operations on two integers.

#include "std_lib_facilities.h"

int main()
{
    cout << "Enter two whole (integer) numbers: ";
    int val1 =  0, val2 = 0;
    cin >> val1 >> val2;
    if (val1 == val2)
